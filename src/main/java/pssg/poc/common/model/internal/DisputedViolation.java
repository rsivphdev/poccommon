...
/**
 * The Class DisputedViolation.
 * @author HLiang
 */
public class DisputedViolation {
	...
	/**
	 * Checks if is disputing allegation.
	 *
	 * @return true, if is disputing allegation
	 */
	public boolean isDisputing_allegation() {
